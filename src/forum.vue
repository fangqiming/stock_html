        ...
        <div class="forum-list-box">
          <div class="recommendRow">
            <div class="recommendHeader">
              <h3></h3>
              <h4 class="recommentTime">毕达讨论区</h4>
            </div>
          </div>
          <div class="forumBox">
            <div class="forumList">
                ...
                <div class="main">
                  ...
                  <div class="main_ft">
                    <div class="main_ft-left">
                      ...
                      <div class="main_ft-left-comment" v-on:click="showComment(index,item.id,item.userCode,'0')">评论
                      </div>
                  ...
                  <criticism v-if="index === motype" @commentReplayData="commentReplayData($event)"
                             @cancelComment="cancelComment($event)"></criticism>
                </div>
              </div>
              <pagination :page-index="currentPage" :total="count" :page-size="pageSize"
