        ...
        <table class="table table-bordered">
          ...
          <tr v-for="(item,index) in  notice">
            <td class="StockPoolText">
              <a :href="item.url" class="strongText" target="_blank"
                 rel="noopener noreferrer"><u>{{item.noticetitle}}</u></a>
            </td>
        ...
        <div class="row-fluid">
          <div class="span12">
            <div class="list">
              <template>
                <div>
                  <table class="table table-striped table-bordered table-advance diagnosticStockInfoTb3"
                    ...
                    <tr v-for="(item,index) in  productPrice">
                      <td class="app_td" @click="showDiaglog(item.name)"
        ...
        <div class="row-fluid">
          <div class="span12">
            <div class="list">
              <template>
                <div>
                  <table id="scoreRange" class="table table-striped table-bordered table-advance diagnosticStockInfoTb3"
                         contenteditable="false">
                    <thead>
                    <tr class="diagnosticStockTbTh3 rankwidth">
                      ...
                      <th @click="changePXData('score',1)">AI评分<i class="iconfont icon-paixu-jiangxu"
                                                                  :class="{isActive:isFlag==1}"></i></th>
                      <th>
                        PEG<br>
                        夏普比率<br>
                        PE/avg_PE
                    ...
                    <tr v-for="(item,index) in  items">
                      <td class="app_td" style="width: 25%;color: rgb(2, 117, 216);cursor: pointer">
                        ...
                        <a :href="item.url" class="strongText blockA" target="_blank" rel="noopener noreferrer"
                           style=";display: block!important;text-align: center"><u>{{item.name}}</u></a>
                      </td>
                      <!-- <td>
                       </td>-->
                      <td>
                        <div id="dialogStockAvgCost" :class="{Green:item.avgCost<0,Red:item.avgCost>=0}"
                             v-if="item.avgCost!=null" class="data_box8"
                             style="width: 100%;color: rgb(2, 117, 216);cursor: pointer">
                          <a :href="item.changeStockUrl" class="strongText blockA" target="_blank"
                             rel="noopener noreferrer" style="display: block!important;text-align: right">
                        ...
                        <div :class="{Green:item.amount<0,Red:item.amount>=0}" v-if="item.amount!=null"
                             class="data_box2">
                          {{item.amount | setNum}}
                        </div>
                        <div v-else class="data_box3">
        ...
        <div class="row-fluid">
          <div class="span12">
            <div class="list">
              <template>
                <div>
                  <table id="femoralPoolScore"
                         class="table table-striped table-bordered table-advance diagnosticStockInfoTb3"
                         contenteditable="false">
                    <thead>
                    <tr class="diagnosticStockTbTh3 rankwidth">
                      <th>
                    ...
                    <tr v-for="(item,index) in  femoralPoolScore">
                      ...
                      <td>
                        <div id="femoralPoolScoreAvgCost" :class="{Green:item.avgCost<0,Red:item.avgCost>=0}"
                             v-if="item.avgCost!=null" class="data_box8"
                             style="width: 100%;color: rgb(2, 117, 216);cursor: pointer;">
                          <a :href="item.changeStockUrl" class="strongText blockA" target="_blank"
                             rel="noopener noreferrer" style="display: block!important;text-align: right;">
