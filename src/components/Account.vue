<template>
  <div class="accountInfo">
    <div class="accountItem">
      <el-row class="header">
        <el-col :span="24"><div class="grid-content title">A股{{accountCnDate}}账户对比</div></el-col>
      </el-row>
      <el-row class="table-head">
        <el-col :span="6"><div class="grid-content bg-purple one-row">账户名</div></el-col>
        <el-col :span="6"><div class="grid-content bg-purple-light"><span>净资产<br/>净值(￥)</span></div></el-col>
        <el-col :span="6"><div class="grid-content bg-purple"><span>收益率<br/>收益差</span></div></el-col>
        <el-col :span="6"><div class="grid-content bg-purple-light"><span>仓位<br/>等仓位跑赢</span></div></el-col>
      </el-row>
      <el-row class="table-body" v-for='(item,index) in  accountCn' :key = 'index'>
        <el-col :span="6"><div class="grid-content bg-purple one-row">{{item.name}}</div></el-col>
        <el-col :span="6"><div class="grid-content bg-purple-light data_box3">
           <span>
              <a>{{item.asset  | setNum}}</a><br />
              <a >{{item.net  | toFixed4}}</a>
            </span>
        </div></el-col>
        <el-col :span="6"><div class="grid-content bg-purple data_box3">
            <span>
              <a :class="{Green:item.gain<0,Red:item.gain>=0}" v-if="item.gain>=0">+{{item.gain*100  | toFixed2}}%</a><br v-if="item.gain>=0"/>
              <a :class="{Green:item.gain<0,Red:item.gain>=0}" v-if="item.gain <0">{{item.gain*100  | toFixed2}}%</a><br v-if="item.gain <0"/>
    ...
    <div class="accountItem">
      <el-row  class="header">
        <el-col :span="24"><div class="grid-content title">美股{{accountUsDate}}账户对比</div></el-col>
      </el-row>
      <el-row class="table-head">
        <el-col :span="6"><div class="grid-content bg-purple one-row">账户名</div></el-col>
        <el-col :span="6"><div class="grid-content bg-purple-light"><span>净资产<br/>净值($)</span></div></el-col>
    ...
    <div class="accountItem">
      <el-row  class="header">
        <el-col  :span="24"><div class="grid-content title">{{accountDiffDate}}账户跟踪误差</div></el-col>
      </el-row>
      <el-row>
        <el-col :xs="24" :lg="8"><div class="grid-content bg-purple content-padding-2">
          <label>开始时间</label>
          <el-date-picker
            v-model="startTime"
            type="date"
        ...
        <el-col :xs="24" :lg="8"><div class="grid-content bg-purple-light content-padding-2">
      ...
      <el-row class="table-head">
        <el-col :span="6"><div class="grid-content bg-purple one-row">账户名</div></el-col>
        <el-col :span="6"><div class="grid-content bg-purple-light"><span>收益率<br/>收益差</span></div></el-col>
        <el-col :span="6"><div class="grid-content bg-purple"><span>平均仓位<br/>等仓位跑赢</span></div></el-col>
        <el-col :span="6"><div class="grid-content bg-purple-light"><span>最大回撤<br/>回撤差</span></div></el-col>
      </el-row>
      <el-row class="table-body" v-for='(item,index) in  accountDiffRange' :key = 'index'>
        <el-col :span="6"><div class="grid-content bg-purple one-row">{{item.account}}</div></el-col>
        <el-col :span="6"><div class="grid-content bg-purple-light data_box3">
          <span>
              <a :class="{Green:item.gain<0,Red:item.gain>=0}" v-if="item.gain>=0">+{{item.gain*100  | toFixed2}}%</a><br v-if="item.gain>=0"/>
              <a :class="{Green:item.gain<0,Red:item.gain>=0}" v-if="item.gain <0">{{item.gain *100 | toFixed2}}%</a><br v-if="item.gain <0"/>
