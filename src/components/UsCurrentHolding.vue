      ...
      <div class="span6" style="float: left; width: 100%">
        <div class="currentHoldingTable">
          ...
          <tr  v-for="(item,index) in holding" >
            ...
            <td>
              <div class="data_box3">
                <span v-if="item.gain>0" :class="{Red:item.gain<0,Green:item.gain>=0}">+{{item.gain  | toFixed2 }}%<br>+{{item.earning  | toInt}}</span>
