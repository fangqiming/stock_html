<template>
  <div>
    <div class="head-content">
      ...
      <div class="row">
        <div v-if="imgItems.length>1" class="col-xs-12 col-md-6" v-for="(item,index) of imgItems">
          <img class="metarilImg" :src="item"/>
        </div>
        <div v-else-if="imgItems.length==1" class="col-md-12" >
          <img class="metarilImg" :src="imgItems[0]"/>
        </div>
      </div>
    </div>
                ...
                <div>
                  <table id="scoreRange" class="table table-striped table-bordered table-advance price-tableInfoTb3" contenteditable="false">
                    ...
                    <tr v-for="(item,index) in  items">
                      <td class="app_td" @click="metailImg(item.identifier)" style="width: 20%;color: rgb(2, 117, 216);cursor: pointer">
                       <u> {{item.name}}</u>
                      </td>
                      <td>
                        <div class="data_box2">
                      ...
                      <td :class="{Green:item.priceBeforeMonth<0,Red:item.priceBeforeMonth>=0}">
                        {{item.priceBeforeMonth}}<span v-if="item.priceBeforeWeek!=null">%</span>
                      </td>
                    </tr>
                    </tbody>
                    <tbody v-else>
