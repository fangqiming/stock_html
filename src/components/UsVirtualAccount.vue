                ...
                <tr>
                  ...
                  <td>
                    <div v-if="todayAccountBo.relativeProfit>0" class="data_box"
                         :class="{Red:todayAccountBo.relativeProfit<0,Green:todayAccountBo.relativeProfit>=0}">
                ...
                <tr>
                  ...
                  <td>
                    <div v-if="todayAccountBo.relativeProfitRate>0" class="data_box"
                         :class="{Red:todayAccountBo.relativeProfitRate<0,Green:todayAccountBo.relativeProfitRate>=0}">
                ...
                <tr>
                  ...
                  <td>
                    <div v-if="todayAccountBo.beatStandardRate>0" class="data_box"
                         :class="{Red:todayAccountBo.beatStandardRate<0,Green:todayAccountBo.beatStandardRate>=0}">
            ...
            <div class="col-md-6 clearPadRig accountOverview2">
              <table cellspacing="0" cellpadding="0" border="0"
                ...
                <tr>
                  ...
                  <td>
                    <div v-if="totalAccountBo.relativeProfit>0" class="data_box"
                         :class="{Red:totalAccountBo.relativeProfit<0,Green:totalAccountBo.relativeProfit>=0}">
                ...
                <tr>
                  ...
                  <td>
                    <div v-if="totalAccountBo.relativeProfitRate>0" class="data_box"
                         :class="{Red:totalAccountBo.relativeProfitRate<0,Green:totalAccountBo.relativeProfitRate>=0}">
                ...
                <tr>
                  ...
                  <td>
                    <div v-if="totalAccountBo.beatStandardRate>0" class="data_box"
                         :class="{Red:totalAccountBo.beatStandardRate<0,Green:totalAccountBo.beatStandardRate>=0}">
                ...
                <tr>
                  ...
                  <td>
                    <div class="data_box">{{totalAccountBo.shortRate != undefined ?
                      (totalAccountBo.shortRate).toFixed(2) : 0}}%
                    </div>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    <div class="data_box">{{totalAccountBo.repoProfit != undefined ?
                      (totalAccountBo.repoProfit).toFixed(2) : 0}}
                    </div>
                  </td>
                </tr>
