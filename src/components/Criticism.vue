<template>
  <div id="publish" class="comment-textarea">
    <div class="bg2 mod_comment_post">
      <p @click=make_face()>
        <img src="https://aisharev1.oss-cn-beijing.aliyuncs.com/share/1.gif" title="表情"
             class="bg_img mod_comment_emoticons"/>
      </p>
      <div class="mod_comment_textarea">
          <span>
                <p contenteditable="true" id="input_conta" cols="60" rows="5" class="textarea textinput"
                   @input="descArea"></p>
          </span>
      </div>
